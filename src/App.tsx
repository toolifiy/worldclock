...
export default function App() {
  ...
  useEffect(() => {
    let title = "Online Stopwatch, Countdown Timer & World Clock - Instant Free Millisecond Lap Timer";
    let description = "Online Stopwatch is a high-precision, millisecond-accurate digital chronometer utility engineered alongside an integrated Countdown Timer and World Clock timezone converter for professional time management, productivity tracking, speedrunning, sports/workout intervals, and remote timesheet audits. Click the spacebar to instantly start or pause, use the L key to log lap splits, or trigger the R key to clear the session. Toggle dynamically between our elite millisecond stopwatch, dynamic countdown visual progress rings with buzzer alarms, and a live international world clock planner with 100% data privacy.";
    
    if (activeTab === 'TIMER') {
      title = "Online Countdown Timer, Stopwatch & World Clock - Instant Free Study Alarm";
      description = "Online Countdown Timer is an ultra-precise, modular browser-based alarm clock and digital interval tracker designed alongside our multi-split Stopwatch and accurate international World Clock timezone converter. Set custom countdown timer durations in hours, minutes, and seconds, or leverage rapid preset templates ranging from 1-minute tests to 1-hour professional work blocks. Toggle easily between setting alarm alerts with audio progress, recording high-precision millisecond stopwatch laps, or converting Greenwich Mean Time (GMT/UTC) across international coordinates.";
    } else if (activeTab === 'WORLD_CLOCK') {
      title = "Online World Clock, Countdown Timer & Stopwatch - Live Multi-City Timezone Converter";
      description = "Online World Clock is a real-time, high-precision global timezone observatory and multi-city coordinates hub engineered alongside our local millisecond tracking Stopwatch and customizable circular Countdown Timer. Monitor exact local wall clock timings across distributed metropolitan regions simultaneously, checking relative daylight timezone differences, GMT alignments, Coordinated Universal Time (UTC) standards, and active Day/Night shifts. Search, discover, and pin customized cities with solar-geometric ambient dials indicating solar positioning with absolute accuracy.";
    } else if (activeTab === 'PRIVACY') {
